                ...
                <div class="action-buttons d-flex justify-content-end">
                    <div class="action-dropdown-container">
                        ...
                        <div class="action-dropdown-menu" id="addBikeDropdown">
                            ...
                            <?php endif; ?>
                            <a class="action-dropdown-item" href="<?php echo e(route('bikes.download-template')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/sxjnqpte/public_html/resources/views/bikes/index.blade.php ENDPATH**/ ?>