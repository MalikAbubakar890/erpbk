        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="exportBikesForm" action="<?php echo e(route('bikes.export-download')); ?>" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php $__currentLoopData = $firstHalf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input export-column"
                                                id="column_<?php echo e($key); ?>" name="columns[]" value="<?php echo e($key); ?>" checked>
                                            <label class="custom-control-label" for="column_<?php echo e($key); ?>">
                                    ...
                                    <div class="col-md-6">
                                        <?php $__currentLoopData = $secondHalf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input export-column"
                                                id="column_<?php echo e($key); ?>" name="columns[]" value="<?php echo e($key); ?>" checked>
                                            <label class="custom-control-label" for="column_<?php echo e($key); ?>">
...
</style><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/bikes/export_modal.blade.php ENDPATH**/ ?>