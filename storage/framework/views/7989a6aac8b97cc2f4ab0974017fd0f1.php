...
<?php $__env->startSection('title','Visa installment plan'); ?>
                            ...
                            <div class="row gy-3">
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card-info">
                                            <h5 class="mb-0"><?php echo e(DB::table('visa_installment_plans')->where('status' , 'pending')->where('rider_id', $account->id)->sum('amount')); ?></h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card-info">
                                            <h5 class="mb-0"><?php echo e(DB::table('visa_installment_plans')->where('status' , 'paid')->where('rider_id', $account->id)->sum('amount')); ?></h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card-info">
                                            <h5 class="mb-0"><?php echo e(DB::Table('visa_installment_plans')->where('rider_id' , $account->id)->where('status' , 'paid')->get()->count()); ?></h5>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="card-info">
                                            <h5 class="mb-0"><?php echo e(DB::Table('visa_installment_plans')->where('rider_id' , $account->id)->where('status' , 'pending')->get()->count()); ?></h5>
...
<div class="content px-3">
    ...
    <div class="card">
        <div class="card-body table-responsive px-2 py-0" id="table-data">
            <?php echo $__env->make('visa_expenses.installmentPlanTable', ['data' => $data, 'account' => $account], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#filterForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('VisaExpense.installmentPlan', $account->id)); ?>",
                type: "GET",
                data: formData,
                success: function(data) {
                    ...
                    // Update URL
                    let newUrl = "<?php echo e(route('VisaExpense.installmentPlan', $account->id)); ?>" + (formData ? '?' + formData : '');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('riders.view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/visa_expenses/installmentPlan.blade.php ENDPATH**/ ?>