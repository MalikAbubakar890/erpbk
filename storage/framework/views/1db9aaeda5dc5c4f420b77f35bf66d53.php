...
<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   ...
   <tbody>
      ...
      <tr class="text-center">
         ...
         <td>
            <?php if($voucher): ?>
            <a href="<?php echo e(route('vouchers.show', $voucher->id)); ?>" target="_blank"><?php echo e($voucherNumber); ?></a>
            <?php else: ?>
            -
            <?php endif; ?>
         </td>
...
</div><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/rta_fines/table.blade.php ENDPATH**/ ?>