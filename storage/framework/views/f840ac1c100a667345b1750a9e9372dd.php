    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('item_create')): ?>
                    <a class="btn btn-primary action-btn show-modal"
                    href="javascript:void(0);" data-size="md" data-title="New Item" data-action="<?php echo e(route('items.create')); ?>">
                        Add New
                    </a>
                    <?php endif; ?>
                       ...
                       <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
                          <div class="modal-content">
                             ...
                             <div class="modal-body" id="searchTopbody">
                                <form id="filterForm" action="<?php echo e(route('items.index')); ?>" method="GET">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="name">Item Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Filter By Item Name" value="<?php echo e(request('name')); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="code">Code</label>
                                            <input type="text" name="code" class="form-control" placeholder="Filter By Code" value="<?php echo e(request('code')); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            <div class="card-body table-responsive px-2 py-0"  id="table-data">
                <?php echo $__env->make('items.table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
    ...
    $('#filterForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Update URL
                let newUrl = "<?php echo e(route('items.index')); ?>" + (formData ? '?' + formData : '');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/items/index.blade.php ENDPATH**/ ?>