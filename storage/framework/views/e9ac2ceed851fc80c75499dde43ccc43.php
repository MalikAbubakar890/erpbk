...
<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>AED <?php echo e(number_format($payment->amount, 2)); ?></td>
            ...
            <td>
                ...
                ?>
                <?php echo e($voucher ? $voucher->trans_code : '-'); ?>

            </td>
            <td><?php echo e($voucher ? $voucher->voucher_type : '-'); ?></td>
            <td>
                <a href="<?php echo e(route('payments.show', $payment->id)); ?>" class="btn btn-sm btn-info" title="View"><i class="fa fa-eye"></i></a>
                <a href="<?php echo e(route('payments.edit', $payment->id)); ?>" class="btn btn-sm btn-warning" title="Edit"><i class="fa fa-pencil"></i></a>
            </td>
            <td></td>
        </tr>
...
</div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/payments/table.blade.php ENDPATH**/ ?>