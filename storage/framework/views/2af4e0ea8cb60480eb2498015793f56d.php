...
<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   ...
   <tbody>
      ...
      <tr class="text-center">
         <td> <a href="<?php echo e(route('rtaFines.tickets' , $r->id)); ?>"><?php echo e($r->name); ?></a><br> </td>
         <?php
         ...
         <td><?php if($account_tax == ''): ?> - <?php else: ?> AED <?php echo e($account_tax); ?><?php endif; ?></td>
         <td><?php if($admin_charges == ''): ?> - <?php else: ?> AED <?php echo e($admin_charges); ?><?php endif; ?></td>
         <td><?php if($total_amount == ''): ?> - <?php else: ?> AED <?php echo e($total_amount ?? '-'); ?> <?php endif; ?></td>
         <td>
            <?php if($r->status == 1): ?>
         ...
         <td>
            <div class="dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actiondropdown" style="">
                  <a href="<?php echo e(route('rtaFines.tickets' , $r->id)); ?>" class='dropdown-item waves-effect'>
                  ...
                  <a href="javascript:void(0);" onclick='confirmDelete("<?php echo e(route('rtaFines.deleteaccount', $r->id)); ?>")' class='dropdown-item confirm-modal' data-size="lg" data-title="Delete Account">
         ...
         <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
            <div class="modal-content">
               ...
               <div class="modal-body" id="searchTopbody">
                  <form action="<?php echo e(route('rtaFines.editaccount')); ?>" method="POST">
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <input type="number" name="account_tax" class="form-control" placeholder="Enter Your Service" value="<?php echo e($r->account_tax); ?>">
                        </div>
                        <div class="form-group col-md-12">
                           <label for="admin_charges">Admin Charges</label>
                           <input type="number" name="admin_charges" class="form-control" placeholder="Enter Your Admin Charges" value="<?php echo e($r->admin_charges); ?>">
                        </div>
...
</div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/rta_fines/account_table.blade.php ENDPATH**/ ?>