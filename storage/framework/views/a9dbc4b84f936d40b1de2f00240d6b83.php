                       ...
                       <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
                          <div class="modal-content">
                             ...
                             <div class="modal-body" id="searchTopbody">
                                <form action="<?php echo e(route('VisaExpense.accountcreate')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control " id="rider_id" name="rider_id">
                                                ...
                                                <?php $__currentLoopData = DB::table('riders')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($r->id); ?>"><?php echo e($r->rider_id); ?> - <?php echo e($r->name); ?></option>
                        ...
                        <div class="row gy-3">
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0"><?php echo e(DB::table('accounts')->where('parent_id' , $parent->id)->count()); ?></h5>
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0">
                                    <?php echo e(DB::table('visa_expenses')->where('payment_status', 'unpaid')->sum('amount')); ?>
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0">
                                    <?php echo e(DB::table('visa_expenses')->where('payment_status', 'paid')->sum('amount')); ?>
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0">
                                    <?php echo e(DB::table('visa_expenses')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            <div class="card-body table-responsive px-2 py-0"  id="table-data">
                <?php echo $__env->make('visa_expenses.account_table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/visa_expenses/account_index.blade.php ENDPATH**/ ?>