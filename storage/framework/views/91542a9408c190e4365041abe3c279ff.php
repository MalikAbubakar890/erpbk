<?php $__env->startSection('page_content'); ?>
          ...
          <div class=" card-action mb-0">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_document')): ?>
            <div class="card-header align-items-center">
              ...
              <a class="btn btn-primary show-modal action-btn"
                       href="javascript:void(0);" data-action="<?php echo e(route('files.create',['type_id'=>request()->segment(3),'type'=>'customer'])); ?>" data-size="sm" data-title="Upload File">
                        Upload File
                    </a>
            </div>
...
<?php echo $__env->make('customers.view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/customers/document.blade.php ENDPATH**/ ?>