            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  ...
                  <a class="btn btn-primary float-right show-modal action-btn"
                     href="javascript:void(0);" data-action="<?php echo e(route('vendors.create')); ?>" data-title="Add New" data-size="lg">
                      Add New
                  </a>
                  <?php endif; ?>
                       ...
                       <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
                          <div class="modal-content">
                             ...
                             <div class="modal-body" id="searchTopbody">
                                <form id="filterForm" action="<?php echo e(route('vendors.index')); ?>" method="GET">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="name">Vendors Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Filter By Vendors Name" value="<?php echo e(request('name')); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="account_id">Filter by Accounts</label>
                                            <select class="form-control " id="account_id" name="account_id">
                                                <?php
                                                $accountid = DB::table('vendors')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            <div class="card-body table-responsive px-2 py-0"  id="table-data">
                <?php echo $__env->make('vendors.table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    $('#filterForm').on('submit', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('vendors.index')); ?>",
            type: "GET",
            data: formData,
            success: function (data) {
                ...
                // Update URL
                let newUrl = "<?php echo e(route('vendors.index')); ?>" + (formData ? '?' + formData : '');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/vendors/index.blade.php ENDPATH**/ ?>