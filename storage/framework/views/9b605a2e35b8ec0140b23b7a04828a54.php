      ...
      pathResolver: function(path) {
        var resolvedPaths = {
          ...
          <?php $__currentLoopData = ['default', 'bordered', 'semi-dark']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            '<?php echo e(asset("assets/vendor/css{$configData['rtlSupport']}/theme-{$name}-dark.css")); ?>',
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        }
...
<?php endif; ?>
<?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/layouts/sections/scriptsIncludes.blade.php ENDPATH**/ ?>