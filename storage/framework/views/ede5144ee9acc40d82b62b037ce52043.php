...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rider_document')): ?>
            <div class="card-header align-items-center">
              ...
              <a class="btn btn-primary show-modal action-btn"
                       href="javascript:void(0);" data-action="<?php echo e(route('files.create',['type_id'=>request()->segment(3),'type'=>'rider'])); ?>" data-size="sm" data-title="Upload File">
                        Upload File
                    </a>
            </div>
...
<?php echo $__env->make('riders.view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/riders/document.blade.php ENDPATH**/ ?>