<input type="hidden" name="payment_from" value="<?php echo e(\App\Helpers\HeadAccount::COD); ?>" />
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <textarea name="narration[]" class="form-control" rows="10" placeholder="COD Payment Received" style="height: 40px !important;">COD Payment Received</textarea>
    </div>
...
<div id="rows-container" class="mb-3" style="width: 100%;">
    ...
    <?php else: ?>
    <!-- Second row for credit account (COD account) -->
    <div class="row">
        <div class="form-group col-md-3">
            <label for="exampleInputEmail1">Select Account</label>
        ...
        <div class="form-group col-md-4">
            <label>Narration</label>
            <textarea name="narration[]" class="form-control" rows="10" placeholder="COD Payment Given" style="height: 40px !important;">COD Payment Given to <?php echo e($rider->name); ?></textarea>
        </div>
        <div class="form-group col-md-2">
            <label>Amount</label>
            <input type="number" step="any" name="dr_amount[]" class="form-control dr_amount" placeholder="COD Amount" onchange="getTotal();" required readonly>
        </div>
    </div>
    <?php endif; ?>
</div><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/riders/cod_fields.blade.php ENDPATH**/ ?>