...
<?php $__env->startSection('title', 'Import Salik Records'); ?>
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a class="btn btn-primary float-right action-btn" href="<?php echo e(route('salik.tickets', $account->id)); ?>" style="color: white; background-color: #007bff;">
                    Back to Salik List
                </a>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Import for Account: <?php echo e($account->name); ?></h3>
                </div>
                <div class="card-body">
                    <form id="salikImportForm" action="<?php echo e(route('salik.import')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="salik_account_id" value="<?php echo e($account->id); ?>">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo e(asset('templates/salik_template.xlsx')); ?>" class="btn btn-sm btn-outline-primary mt-2" download>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="admin_charge_per_salik" id="admin_charge_per_salik"
                                        class="form-control" step="0.01" min="0" value="<?php echo e($account->admin_charges ?? 0); ?>">
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('salik.tickets', $account->id)); ?>";
                        }, 2000);
                    } else {
        ...
        $('#testBtn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('salik.test.import')); ?>",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/salik/import.blade.php ENDPATH**/ ?>