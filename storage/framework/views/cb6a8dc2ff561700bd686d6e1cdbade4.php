...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Visa Staus  #<?php echo e($data->visa_status); ?></h3>
            </div>
            <!-- <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped">
                                <tr>
                                    <th>Visa Status</th>
                                    <td class="text-end"><?php echo e($data->visa_status); ?></td>
                                </tr>
                                <tr>
                                    <th>Rider name</th>
                                    <?php
                                ...
                                <tr>
                                    <th>Date</th>
                                    <td class="text-end"><?php echo e($data->date); ?></td>
                                </tr>
                                <tr>
                                    <th>Amount</th>
                                ...
                                <tr>
                                    <th>Paid By</th>
                                    <td class="text-end"><?php echo e(DB::table('accounts')->where('id' , $data->pay_account)->first()->name); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    <th></th>
    ...
    <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
        <div class="modal-content">
            ...
            <div class="modal-body" id="searchTopbody">
                <form enctype="multipart/form-data" action="<?php echo e(route('VisaExpense.payfine')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                    <input type="hidden" name="rider_id" value="<?php echo e($data->rider_id); ?>">
                    ...
                    <div class="row">
                        <?php echo $__env->make('visa_expenses.voucherfield', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <div class="col-md-12 form-group text-center">
                            <button type="submit" class="btn btn-primary pull-right mt-3"><i class="fa fa-filter mx-2"></i> Submit</button>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/visa_expenses/viewvoucher.blade.php ENDPATH**/ ?>