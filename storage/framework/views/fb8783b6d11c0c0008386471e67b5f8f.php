      ...
      <tr class="text-center">
         ...
         <td>
            <div class='btn-group'>
               ...
               <a href="javascript:void(0);" data-action="<?php echo e(route('vendors.edit', $r->id)); ?>" class='btn btn-info btn-sm show-modal' data-size="lg" data-title="Update Vendors">
                  <i class="fa fa-edit"></i>
               </a>
               <?php endif; ?>
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('vendor_delete')): ?>
               <a href="javascript:void(0);" onclick='confirmDelete("<?php echo e(route('vendors.delete', $r->id)); ?>")' class='btn btn-danger btn-sm confirm-modal' data-size="lg" data-title="Delete Item">
...
</div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/vendors/table.blade.php ENDPATH**/ ?>