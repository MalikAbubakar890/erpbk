<?php $__env->startSection('title', 'Import Bikes'); ?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('bikes.index')); ?>">Bikes</a></li>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('bikes.processImport')); ?>" method="POST" enctype="multipart/form-data" id="importBikesForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mt-4">
                                ...
                                <a href="<?php echo e(route('bikes.index')); ?>" class="btn btn-secondary">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3 align-items-center justify-content-center">
                            <a href="<?php echo e(route('bikes.download-template')); ?>" class="btn btn-info btn-sm btn-block">
                                <i class="fas fa-download"></i> Download Excel Template
                            </a>
                            <a href="<?php echo e(asset('bikes_import_data.csv')); ?>" class="btn btn-success btn-sm btn-block" download>
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?php echo e(route('bikes.index')); ?>";
                            }
                        });
                    } else {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/bikes/import.blade.php ENDPATH**/ ?>