            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <a class="action-btn btn btn-success" style="margin-right:5px;"
                        href="<?php echo e(route('garage-items.create')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/vouchers/index.blade.php ENDPATH**/ ?>