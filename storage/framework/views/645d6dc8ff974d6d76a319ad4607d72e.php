...
<?php $__env->startSection('title','Vehicals'); ?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <a class="btn btn-primary action-btn show-modal"
                    href="javascript:void(0);" data-size="xl" data-title="Add New Vehical" data-action="<?php echo e(route('bikes.create')); ?>">
                    Add New
                </a>
                <?php endif; ?>
...
<div class="content px-3">
    ...
    <div class="card">
        <div class="card-body table-responsive px-2 py-0" id="table-data">
            <?php echo $__env->make('bikes.table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#filterForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('bikes.index')); ?>",
                type: "GET",
                data: formData,
                success: function(data) {
                    ...
                    // Update URL
                    let newUrl = "<?php echo e(route('bikes.index')); ?>" + (formData ? '?' + formData : '');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/bikes/index.blade.php ENDPATH**/ ?>