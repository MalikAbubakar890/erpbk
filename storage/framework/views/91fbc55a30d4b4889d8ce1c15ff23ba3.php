...
<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   ...
   <tbody>
      ...
      <tr class="text-center">
         ...
         <td>
            <div class='btn-group'>
               <!-- <a href="javascript:void(0);" data-size="md" data-title="New Item" data-action=="<?php echo e(route('leasingCompanies.show', $r->id)); ?>" class='btn btn-default btn-xs'>
                    <i class="fa fa-eye"></i>
                </a> -->
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leasing_edit')): ?>
               <a href="javascript:void(0);" data-size="lg" data-title="Update Leasing Company" data-action="<?php echo e(route('leasingCompanies.edit', $r->id)); ?>" class='btn btn-info btn-sm show-modal'>
               <i class="fa fa-edit"></i>
               </a>
               <?php endif; ?>
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('leasing_delete')): ?>
               <a href="javascript:void(0);"  onclick='confirmDelete("<?php echo e(route('leasingCompanies.delete', $r->id)); ?>")' class='btn btn-danger btn-sm confirm-modal' data-size="lg" data-title="Delete Sim">
...
</div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/leasing_companies/table.blade.php ENDPATH**/ ?>