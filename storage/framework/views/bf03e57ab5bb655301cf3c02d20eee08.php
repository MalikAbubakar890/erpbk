...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   <head>
      ...
      <title>Rider# <?php echo e($contract->rider->rider_id); ?> Bike Handing Over</title>
   ...
   <body style="padding:5px;" >
    ...
    <div style="height: 130px;">&nbsp;</div>
      ...
      <table style="border-collapse:collapse;width:100%;" >
        <tr>
            ...
            <td style="padding:5px;"><?php echo e(App\Helpers\General::RiderStatus(@$contract->rider->status)); ?></td>
            <th style="padding:5px 5px 5px 50px;">Supervisor:</th>
            <td style="padding:5px;"><?php echo e(@$contract->rider->fleet_supervisor); ?></td>
            <th style="padding:5px 5px 5px 150px;">Date:</th>
            <td style="padding:5px 5px 5px 5px;"><?php echo e(@$contract->note_date); ?></td>
        </tr>
      </table>
      ...
      <table style="border-collapse:collapse;width:100%;" cellspacing="0">
         <tr style="height:16pt">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->name); ?></p>
            </td>
            ...
            <td style="width:161pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->rider_id); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->emirate_id); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Passport No.</p>
            </td>
            <td style="width:161pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->passport); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->personal_contact); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">License No.</p>
            </td>
            <td style="width:161pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->license_no); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->personal_email); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Emirate.</p>
            </td>
            <td style="width:161pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->emirate_hub); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->rider->vendor->name); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
      ...
      <table style="border-collapse:collapse;width:100%;" cellspacing="0">
         <tr style="height:16pt">
            ...
            <td style="width:160pt;border:1px solid #000000;">
               <p style="text-indent: 0pt;text-align: left;"><?php echo e(@$contract->rider->sims->sim_number); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 8pt;text-indent: 0pt;text-align: left;">EMI Number.</p>
            </td>
            <td style="width:161pt;border:1px solid #000000;">
               <p style="text-indent: 0pt;text-align: left;"><?php echo e(@$contract->rider->sims->sim_emi); ?></p>
            </td>
         </tr>
      </table>
      ...
      <table style="border-collapse:collapse;" cellspacing="0">
         <tr style="height:16pt">
            ...
            <td style="width:175pt;border:1px solid #000000;" colspan="2">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->traffic_file_number); ?></p>
            </td>
            ...
            <td style="width:205pt;border:1px solid #000000;" colspan="2">
               ...
               <p class="s3" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->plate); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:175pt;border:1px solid #000000;" colspan="2">
               <p class="s8" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->model); ?></p>
            </td>
            <td style="width:92pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Bike</p>
            </td>
            <td style="width:205pt;border:1px solid #000000;" colspan="2">
               <p class="s4" style="padding-top: 1pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->model_type); ?></p>
            </td>
         </tr>
         <tr style="height:16pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:175pt;border:1px solid #000000;" colspan="2">
               ...
               <p class="s4" style="padding-top: 1pt;padding-left: 55pt;text-indent: 0pt;text-align: left;"><?php echo e(@$contract->bike->engine); ?></p>
            </td>
            <td style="width:92pt;border:1px solid #000000;">
               <p class="s3" style="padding-top: 1pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Chassis No.</p>
            </td>
            <td style="width:205pt;border:1px solid #000000;" colspan="2">
               <p class="s4" style="padding-top: 1pt;padding-left: 52pt;text-indent: 0pt;text-align: left;"><?php echo e(@$contract->bike->chassis_number); ?></p>
            </td>
         </tr>
                ...
                <table style="width: 100%;text-align:center;">
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo e(@$contract->rider->name); ?></p>
                        </td>
                        <td>
                            <p><b>Supervisor Signature</b><br/>
                                <?php echo e(@$contract->rider->fleet_supervisor); ?></p>
                        </td>
                    </tr>
                </table>
    ...
    <div style="height: 130px;">&nbsp;</div>
      <h1 style="padding-left: 8pt;text-indent: 0pt;text-align: left;">Declaration:                                     Date: <?php echo e(@$contract->note_date); ?></h1>
      ...
      <table style="border-collapse:collapse;width:100%;" cellspacing="0">
         <tr style="height:22pt">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s13" style="padding-top: 3pt;padding-left: 39pt;text-indent: 0pt;text-align: left;"><?php echo e(@$contract->rider->name); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
            ...
            <td style="width:168pt;border:1px solid #000000;">
               <p class="s13" style="padding-top: 3pt;padding-left: 34pt;text-indent: 0pt;text-align: left;"><?php echo e(@$contract->rider->emirate_id); ?></p>
            </td>
         </tr>
      </table>
      ...
      <table style="border-collapse:collapse;width:100%;" cellspacing="0">
         <tr style="height:22pt">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->traffic_file_number); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s13" style="padding-top: 3pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Bike Plate No.</p>
            </td>
            <td style="width:168pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->plate); ?></p>
            </td>
         </tr>
         <tr style="height:22pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->model); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s13" style="padding-top: 3pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Bike</p>
            </td>
            <td style="width:168pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->model_type); ?></p>
            </td>
         </tr>
         <tr style="height:22pt">
            <td style="width:81pt;border:1px solid #000000;">
            ...
            <td style="width:238pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->engine); ?></p>
            </td>
            <td style="width:73pt;border:1px solid #000000;">
               <p class="s13" style="padding-top: 3pt;padding-left: 1pt;text-indent: 0pt;text-align: left;">Chassis No.</p>
            </td>
            <td style="width:168pt;border:1px solid #000000;">
               <p class="s15" style="padding-top: 3pt;text-indent: 0pt;text-align: center;"><?php echo e(@$contract->bike->chassis_number); ?></p>
            </td>
         </tr>
        ...
        <tr>
            ...
            <td>
                <p>
                    ...
                    <b><?php echo e(@$contract->rider->name); ?></b>
...
<?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/bikes/contract.blade.php ENDPATH**/ ?>