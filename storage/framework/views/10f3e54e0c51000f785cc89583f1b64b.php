...
<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   ...
   <tbody>
      ...
      <tr class="text-center">
         <td><a href="<?php echo e(route('customer.files', $r->id)); ?>"><?php echo e($r->name); ?></a><br/></td>
        ...
        <td><?php echo e(number_format($finalBalance, 2)); ?></td>
         ...
         <td>
            <div class='btn-group'>
               <!-- <a href="javascript:void(0);" data-action="<?php echo e(route('customers.show', $r->id)); ?>" class='btn btn-default btn-sm show-modal' data-size="lg" data-title="View">
                  <i class="fa fa-eye"></i>
                  </a> -->
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_edit')): ?>
               <a href="javascript:void(0);" data-action="<?php echo e(route('customers.edit', $r->id)); ?>" class='btn btn-info btn-sm show-modal' data-size="lg" data-title="Update Customer">
               <i class="fa fa-edit"></i>
               </a>
               <?php endif; ?>
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer_delete')): ?>
               <a href="javascript:void(0);"  onclick='confirmDelete("<?php echo e(route('customers.delete', $r->id)); ?>")' class='btn btn-danger btn-sm confirm-modal' data-size="lg" data-title="Delete Customer">
...
</div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/customers/table.blade.php ENDPATH**/ ?>