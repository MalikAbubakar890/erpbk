<input type="hidden" name="payment_from" value="<?php echo e(\App\Helpers\HeadAccount::PENALTY); ?>" />
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <textarea name="narration[]" class="form-control" rows="10" placeholder="Penalty Received" style="height: 40px !important;">Penalty Received</textarea>
    </div>
    <div class="form-group col-md-2">
        <label>Amount</label>
        <input type="number" step="any" name="dr_amount[]" class="form-control dr_amount" placeholder="Penalty Amount" onchange="getTotal();" required>
    </div>
</div>
<div id="rows-container" class="mb-3" style="width: 100%;">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            <label>Narration</label>
            <textarea name="narration[]" class="form-control" rows="10" placeholder="Penalty Given" style="height: 40px !important;">Penalty Given to <?php echo e($rider->name); ?></textarea>
        </div>
        <div class="form-group col-md-2">
            <label>Amount</label>
            <input type="number" step="any" name="dr_amount[]" class="form-control dr_amount" placeholder="Penalty Amount" onchange="getTotal();" required readonly>
        </div>
    </div>
    <?php endif; ?>
</div><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/riders/penalty_fields.blade.php ENDPATH**/ ?>