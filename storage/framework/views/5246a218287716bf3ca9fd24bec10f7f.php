...
<div class="row">
    <div class="col-md-2 form-group">
        ...
        <input type="date" class="form-control form-control" value="<?php echo e(date('Y-m-d')); ?>" name="inv_date" placeholder="Invoice Date">
    </div>
    <!--col-->
...
<div class="">
    ...
    </div><?php /**PATH /home/1509079.cloudwaysapps.com/jyujyqeajn/public_html/resources/views/rider_invoices/fields.blade.php ENDPATH**/ ?>