...
<link rel="stylesheet" href="{{ asset('css/garage-items-styles.css') }}">
@endpush
    ...
    <div class="filter-body">
        <form id="filterForm" class="filter-form">
            <div class="form-group">
                ...
                <input type="text" name="sidebar_name" id="sidebar_name" class="form-control" placeholder="Search by name" value="{{ request('name', '') }}">
            </div>
            <div class="form-group">
                <label for="sidebar_item_code">Item Code</label>
                <input type="text" name="sidebar_item_code" id="sidebar_item_code" class="form-control" placeholder="Search by item code" value="{{ request('item_code', '') }}">
            </div>
            <div class="form-group">
                <label for="sidebar_supplier_id">Supplier</label>
                {!! Form::select('sidebar_supplier_id', $suppliers, request('supplier_id', ''), ['class' => 'form-control', 'id' => 'sidebar_supplier_id']) !!}
            </div>
            <div class="form-group">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('garage-items.create') }}" class="btn btn-primary float-end">
        ...
        <div class="card-body">
            ...
            <div class="filter-status mb-3">
                <div class="filter-info">
                    ...
                    <a href="{{ route('garage-items.index') }}" class="btn btn-sm btn-outline-secondary ms-2">
                        <i class="ti ti-x"></i>
                        Clear All
                    </a>
                </div>
