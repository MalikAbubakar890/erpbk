         ...
         <td>
            <div class="dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actiondropdown" style="">
                  ...
                  <a href="javascript:void(0);" onclick='confirmDelete("{{route('VisaExpense.deleteaccount', $r->id) }}")' class='dropdown-item waves-effect confirm-modal' data-size="lg" data-title="Delete Account">
                     ...
                     <div class="row">
                        <div class="form-group col-md-12">
                           ...
                           <select class="form-control rider-select" id="rider" name="rider_id">
                              ...
                              <option value="{{ $ri->id }}" @if($ri->id == $r->ref_id) selected @endif>{{ $ri->rider_id }} - {{ $ri->name }}</option>
                              @endforeach
                           </select>
                        </div>
