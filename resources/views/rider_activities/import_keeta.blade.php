...
<form action="{{route('rider.keeta_activities_import')}}" method="POST" enctype="multipart/form-data" id="formajax">
    @csrf
    <div class="row">
        <div class="col-12">
            <a href="{{url('sample/keeta_activity_sample.csv')}}" class="text-success w-100" download="Keeta Activities Sample">
