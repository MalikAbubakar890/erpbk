@if($salik->attachment_path)
<a href="{{ asset('storage/' . $salik->attachment_path) }}" class="btn btn-default" target="_blank">
    @if(in_array($salik->attachment_path,['jpeg','jpg','png']))
...
<form action="{{url('salik/attach_file/'.$id)}}" method="POST" enctype="multipart/form-data" id="formajax">
    <div class="row">
