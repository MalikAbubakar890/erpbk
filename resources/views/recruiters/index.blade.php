                    ...
                    <div class="modal-dialog modal-lg modal-slide-top modal-full-top">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="searchTopbody">
                                <form id="filterForm" action="{{ route('recruiters.index') }}" method="GET">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="name">Recruiters Name</label>
                                            <input type="text" name="name" class="form-control" placeholder="Filter By Recruiters Name" value="{{ request('name') }}">
                                        </div>
                                        <div class="form-group col-md-4">
...
<div class="content px-3">
    ...
    <div class="card">
        <div class="card-body table-responsive px-2 py-0" id="table-data">
            @include('recruiters.table', ['data' => $data])
        </div>
    </div>
</div>
        ...
        $('#filterForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Update URL
                    let newUrl = "{{ route('recruiters.index') }}" + (formData ? '?' + formData : '');
