...
<div class="scrollbar">
    ...
    <div id="rows-container" class="mb-3" style="width: 100%;">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                <label>Amount</label>
                <input type="number" step="any" name="dr_amount[]" value="{{$entry->debit}}" class="form-control  dr_amount" onchange="getTotal();" placeholder="Payment Amount">
            </div>
        </div>
        @endforeach
        @else
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                <label>Narration</label>
                <textarea name="narration[]" class="form-control" rows="10" placeholder="Payment Amount Given" style="height: 40px !important;">Payment Amount Given to {{ $rider->name ?? 'Rider' }}</textarea>
            </div>
            <div class="form-group col-md-2">
