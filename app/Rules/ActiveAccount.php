...
/**
 * Custom validation rule to check if an account is active
 */
class ActiveAccount implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $result = $this->validator->validateAccount($value);
    ...
    {
        return $this->message ?? 'The selected account is not active.';
    }
}
